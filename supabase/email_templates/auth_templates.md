# Auth Email Templates (Admin-Only System)

Copy and paste these HTML templates into your Supabase Dashboard -> Authentication -> Email Templates.

> [!NOTE]
> Ensure **"Enable Signups"** is OFF and **"Enable Email OTP"** is ON in your Supabase Auth settings.

## Confirm Sign up / Activate Account
*(Used when an Admin creates an account and Supabase requires email verification)*

**Subject**: Ativar sua conta - SIS DAVUS
...
<head>
   ...
   <!-- Styles -->
    <style>
        ...
        .btn { display: inline-block; background-color: #ff5d38; color: #ffffff; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; margin: 32px 0; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="{{ .ConfirmationURL }}" class="btn">Ativar Minha Conta</a>
        </div>
        <div class="footer">
            <p>&copy; 2026 SIS DAVUS. Todos os direitos reservados.</p>
        </div>
    </div>
</body>
</html>
...
## Invite User
*(Primary email when using "Invite User" from dashboard)*

**Subject**: Você recebeu acesso ao SIS DAVUS
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Um administrador criou uma conta para você no SIS DAVUS.</p>
            <p>Clique abaixo para aceitar o convite e configurar sua senha.</p>
            <a href="{{ .ConfirmationURL }}" class="btn">Configurar Conta</a>
        </div>
        <div class="footer">
            <p>&copy; 2026 SIS DAVUS. Todos os direitos reservados.</p>
        </div>
...
*(Triggered by Admin or by User in Settings)*

**Subject**: Redefinição de senha - SIS DAVUS
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Se você ou um administrador solicitou isso, clique abaixo para criar uma nova senha.</p>
...
**Subject**: Link de acesso admin - SIS DAVUS
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Use o link abaixo para acessar o sistema.</p>
            <a href="{{ .ConfirmationURL }}" class="btn">EntrarAgora</a>
        </div>
        <div class="footer">
            <p>&copy; 2026 SIS DAVUS. Todos os direitos reservados.</p>
        </div>
...
## Email Change
*(Only triggered if Admin changes user email)*

**Subject**: Mudança de e-mail solicitada - SIS DAVUS
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Confirmar Novo E-mail</h2>
            <p>O administrador atualizou seu endereço de e-mail.</p>
            <p>Confirme esta alteração clicando abaixo.</p>
...
*(Required for "Verify OTP" email in Dashboard)*

**Subject**: Seu código de verificação - SIS DAVUS
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 14px;">Este código expira em breve. Não o compartilhe com ninguém.</p>
        </div>
        <div class="footer">
            <p>&copy; 2026 SIS DAVUS. Todos os direitos reservados.</p>
        </div>
...
# Security & MFA Templates (Edge Function)

> [!IMPORTANT]
> These templates are **NOT** configured in the Supabase Dashboard.
> They are stored in `supabase/functions/send-email/templates.ts`.
> To edit them, you must modify the Edge Function code and redeploy (`npx supabase functions deploy send-email`).

## Password Changed
*(Sent when `auth.users.encrypted_password` changes)*
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>Detectamos que a senha da sua conta <strong>${data.email}</strong> foi alterada.</p>
...
*(Sent when `auth.users.email` changes)*
...
## MFA Method Added
*(Sent when a new 2FA factor is added)*
...
## MFA Method Removed
*(Sent when a 2FA factor is removed)*
...
## New Device Login
*(Sent when a new IP address is detected in access_logs)*
