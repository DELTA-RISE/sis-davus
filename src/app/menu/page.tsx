...
const allMenuItems = [
  ...
  { href: "/estoque/por-obra", icon: Briefcase, label: "Estoque por Centro", description: "Resumo por centro de custo", category: "admin", color: "bg-orange-500/20 text-orange-500" },
